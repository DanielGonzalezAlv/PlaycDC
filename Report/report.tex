...
\cline{1-2}
Dataset    & Description  & Precision & Recall & mAP \\
\hline
1 - Simple      & Paste cards on simple canvases    &  0.111  & &  \\
          & \textit{random rotations, brightness, blurring}     &  13 & & \\
2 - Medium       & Paste randomly scaled cards on simple canvases     &  2 & &   \\
          & \textit{random rotations, brightness, blurring}     &  13 & & \\
3 - Elaborate       & Paste randomly scaled cards on textures     &  2 & &   \\
          & \textit{random rotations, brightness, blurring}     &  13 & & \\
4 - Hardest & Paste randomly scaled cards on textures       &  2 & &   \\
          & \textit{random rotations, brightness, blurring}     &  13 & & \\
\hline
