...
\subfloat[]{%
\includegraphics[scale=0.1125]{images/2h_2}  \ 
\includegraphics[scale=0.7]{images/2h_4}}  
\qquad
\subfloat{%
\includegraphics[scale=0.1125]{images/4c_2}  \  
\includegraphics[scale=1.27]{images/4c_4}}  
\qquad
\subfloat{%
\includegraphics[scale=0.1125]{images/6c_2}  \
\includegraphics[scale=0.7]{images/6c_4}}  
\qquad
\subfloat[]{%
\includegraphics[scale=0.1125]{images/5h_2}  \
\includegraphics[scale=1.27]{images/5h_4}}  
\qquad
\subfloat{%
\includegraphics[scale=0.1125]{images/qc_2}  \
\includegraphics[scale=0.7]{images/qc_4}}  
\qquad
\subfloat{%
\includegraphics[scale=0.1125]{images/as_2}  \
\includegraphics[scale=1.25]{images/as_4}}  
\qquad
...
\captionsetup[subfigure]{labelformat=empty}
\subfloat[]{%
\includegraphics[scale=0.17]{images/ch_vs_bb}  }
...
For these tasks, different deep learning architectures have emerged, of which \begin{wrapfigure}{l}{0.40\textwidth}
